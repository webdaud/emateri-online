...
<?php if(Session::has('register_success')): ?>
  ...
  <div class="col-xs-6 col-sm-4">
    ...
    <div class="form-group col-xs-8"> 
     <input type="text" name="matakuliah" class="form-control input-md" placeholder="Tambah Mata Kuliah" >
    </div>
...
<!-- List Matakuliah-->
  <table width="775" align="center" class=" ">
     <thead>
      <tr>
        @foreach ($matakuliah as $matakuliah2)
        <td align="left" ><p align="center"><h3>{{$matakuliah2->matakuliah}}  
