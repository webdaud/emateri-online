...
<div class="container">
  <div class="page-header">
    <h3>Edit Nama Mata Kuliah</h3>
  </div>
</div>


{{Form::open(array('url'=>'/dosen/matakuliah_edit/input_data'))}}
 
    
    <div class="row">
    <div class="form-group col-xs-6 col-md-offset-3"> 
    <div class=" "> 
     <input type="text" name="matakuliah" class="form-control input-lg" value="{{ $edit->matakuliah}}"  >
     <p>&nbsp;</p>
     <div  > 
